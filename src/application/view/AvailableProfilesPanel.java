...
public class AvailableProfilesPanel extends JPanel{
	...
	public AvailableProfilesPanel() {
		...
		availableProfiles.setFont(GameFonts.PROFILES_FONT);
		availableProfiles.setSelectionMode(DefaultListSelectionModel.SINGLE_SELECTION);
		...
		startGameButton.setFont(GameFonts.BUTTONS_FONT);

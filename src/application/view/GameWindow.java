...
public class GameWindow extends JFrame{
	...
	public GameWindow() {
		...
		mainPanel.add("about panel", aboutPanel);
	...
	public void setMenuController(MenuController controller) {
		//ERRORE
		this.getRootPane().getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW) .put(KeyStroke.getKeyStroke("P"), "full screen");
		...
		aboutPanel.setController(controller);
	}
	...
	public void switchToPanel(String name) {
		...
		else if(name.equals("about panel")) {
			cL.show(mainPanel, name);
		}
